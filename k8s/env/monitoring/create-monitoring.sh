...
helm upgrade --install kube-prometheus coreos/kube-prometheus --namespace $namespace --set grafana.serverDashboardConfigmaps[0]=custom-dashboards,grafana.image.tag=5.4.3
